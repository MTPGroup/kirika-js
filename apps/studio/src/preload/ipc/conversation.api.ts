...
export const conversationApi: ConversationApi = {
  listConversations: () => invoke<readonly ConversationSummaryDto[]>(conversationChannels.list),
  createConversation: (input) => invoke<ConversationDto>(conversationChannels.create, input),
  createTestConversation: (input) =>
    invoke<ConversationDto>(conversationChannels.createTest, input),
  getConversation: (input) => invoke<ConversationDto | null>(conversationChannels.get, input),
  getConversationHistory: (input) =>
    invoke<GetConversationHistoryResult>(conversationChannels.getHistory, input),
  deleteConversation: (input) => invoke<void>(conversationChannels.delete, input),
  renameConversation: (input) => invoke<ConversationDto>(conversationChannels.rename, input),
  ...
  sendHumanMessage: (input) =>
    invoke<ConversationMessageDto>(conversationChannels.sendHumanMessage, input),
  selectConversationBranch: (input) =>
    invoke<ConversationDto>(conversationChannels.selectBranch, input),
  archiveConversation: (input) => invoke<ConversationDto>(conversationChannels.archive, input),
  restoreConversation: (input) => invoke<ConversationDto>(conversationChannels.restore, input),
}
