...
ALTER TABLE "lorebook_revisions" ADD CONSTRAINT "lorebook_revisions_lorebook_id_lorebooks_id_fkey" FOREIGN KEY ("lorebook_id") REFERENCES "lorebooks"("id") ON DELETE CASCADE;